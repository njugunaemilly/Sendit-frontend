...
const Nav = () => {
    ...
    const navigation = [
        ...
        { title: "Tracking", path: "javascript:void(0)" },
    ...
    return (
        <nav className={`bg-white pb-0 md:text-sm ${state ? "shadow-lg rounded-xl border mx-0 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-0" : ""}`}>
